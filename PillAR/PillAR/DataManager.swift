...
class DataManager {
    ...
    init(){
        ...
        pillHistoryData.append(HistoryData(drugName: "Advil", maxDailyDosage: 3, todayDose: 1, timeTaken: dateFormatter.date(from: "09-06-2017 17:31:25 EST")!))
        ...
        pillHistoryData.append(HistoryData(drugName: "Advil", maxDailyDosage: 3, todayDose: 1, timeTaken: dateFormatter.date(from: "09-09-2017 7:15:11 EST")!))
        pillHistoryData.append(HistoryData(drugName: "Zyrtec", maxDailyDosage: 1, todayDose: 1, timeTaken: dateFormatter.date(from: "09-09-2017 8:35:51 EST")!))
        pillHistoryData.append(HistoryData(drugName: "Advil", maxDailyDosage: 3, todayDose: 2, timeTaken: dateFormatter.date(from: "09-09-2017 11:15:35 EST")!))
        pillHistoryData.append(HistoryData(drugName: "Advil", maxDailyDosage: 3, todayDose: 3, timeTaken: dateFormatter.date(from: "09-09-2017 15:53:26 EST")!, actionStatement: "YOU MAY NEED TO REFILL SOON"))
        pillHistoryData.append(HistoryData(drugName: "Alka-Seltzer", maxDailyDosage: 5, timeTaken: dateFormatter.date(from: "09-09-2017 19:20:01 EST")!))
